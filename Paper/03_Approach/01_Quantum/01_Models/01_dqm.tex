...
As mentioned in section (\ref{fundamentals:annealing}), this model is an extension of Binary Quadratic Models (BQM) or Quadratic Unconstrained Binary Optimization model (QUBO).
...
\begin{align}
  &
  \forall i \in \I, t, t' \in \T, t < t':
  &
  \Rightarrow m(i, t) < m(i, t')
  \\
  \land \quad
  &
  \forall i, j \in \I, t \in \T, i < j:
  &
