...
\begin{figure}
  \centering
  \includegraphics[width=0.7 \textwidth]{02_Background/ibm_qv_history.png}
  \caption{Quantum Volume achieved by IBM over the years \cite{IBMqv2020}}
  \label{figure:gate.qv.history}
\end{figure}

Even though, quantum volume is a better measurement of the power of a quantum processor, the qubit count is still important.
...
\begin{figure}
  \centering
  \includegraphics[width=0.7 \textwidth]{02_Background/ibm_qubits_projection.png}
  \caption{Projected Qbit Count of IBM Quantum Processors \cite{IBMRoadmap2020}}
